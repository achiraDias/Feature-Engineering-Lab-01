...
kNeighborsClassifier.fit(train_features_copy, train_label3_copy)
...
# %%
# Plot distribution of train_label3
...
# %% [markdown]
# Extract the features that are only highly correlated with the label3
...
df.to_csv('190137J_label_3.csv', index=False)
